...
$search_statu = route(1); if( !route(1) ):  $route[1] = "all";  endif;
  ...
  if( route(2) ):
    ...
    if( route(1) != "all" ): $search  = "AND refill_status='".route(1)."'"; else: $search = ""; endif;
    ...
    $orders = $conn->prepare("SELECT * FROM refill_status WHERE client_id=:c_id $search ORDER BY order_id DESC LIMIT $to OFFSET $where ");
