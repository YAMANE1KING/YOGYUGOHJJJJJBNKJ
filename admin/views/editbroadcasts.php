         ...
         <textarea class="form-control" id="summernoteExample" rows="5" name="description" placeholder="" required> <?= $notifData['description']; ?> </textarea>
                ...
                <div class="form-group">
                        ...
                        <select class="form-control" name="status">
                            ...
                            <option value="0" <span> <? if($notifData['status']==0){ echo 'selected'; } ?>Inactive </span> </option>
                            <option value="1"<span> <? if($notifData['status']==1){ echo 'selected'; } ?> Active </span></option>
                        </select>    
                </div>
